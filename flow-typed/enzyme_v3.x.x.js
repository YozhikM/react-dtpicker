...
declare module "enzyme" {
  declare type PredicateFunction<T: Wrapper<any>> = (
    wrapper: T,
    index: number
  ) => boolean;
  ...
  declare class Wrapper<INSTANCE> {
    ...
    instance(): $PropertyType<$PropertyType<INSTANCE, 'type'>, 'prototype'>, // React.Component<*, *>,
    update(): this,
    debug(): string,
  ...
  declare class ReactWrapper<T> extends Wrapper<T> {
    constructor(nodes: NodeOrNodes, root: any, options?: ?Object): ReactWrapper<T>,
    mount(): this,
